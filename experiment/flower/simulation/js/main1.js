...
function bladejsclickcutsection() {
  ...
  function framets2() {
    if (bladeleftts2 == 20) {
      ...
      document.getElementById("fingerthumbcssts").style.display = "block";
      document.getElementById("fingerindexcssts").style.display = "block";
...
function brushclick() {
  document.getElementById("fingerthumbcssts").style.top = 8 + "%";
  document.getElementById("fingerthumbcssts").style.left = 54 + "%";
  document.getElementById("fingerindexcssts").style.top = 8 + "%";
  document.getElementById("fingerindexcssts").style.left = 54 + "%";
...
function movebrushclick() {
  ...
  document.getElementById("fingerthumbcssts").style.top = 12 + "%";
  document.getElementById("fingerthumbcssts").style.left = 56 + "%";
  document.getElementById("fingerindexcssts").style.top = 12 + "%";
  document.getElementById("fingerindexcssts").style.left = 56 + "%";
...
function movebrushorgclick() {
  ...
  document.getElementById("fingerthumbcssts").style.top = 8 + "%";
  document.getElementById("fingerthumbcssts").style.left = 91 + "%";
  document.getElementById("fingerindexcssts").style.top = 8 + "%";
  document.getElementById("fingerindexcssts").style.left = 91 + "%";
}
...
function movetoglassslideclick() {
  ...
  document.getElementById("fingerthumbcssts").style.top = 20 + "%";
  document.getElementById("fingerthumbcssts").style.left = 83 + "%";
  document.getElementById("fingerindexcssts").style.top = 20 + "%";
  document.getElementById("fingerindexcssts").style.left = 83 + "%";
}



function movetobrushorg2click() {
  document.getElementById("fingerthumbcssts").style.display = "none";
  document.getElementById("fingerindexcssts").style.display = "none";
